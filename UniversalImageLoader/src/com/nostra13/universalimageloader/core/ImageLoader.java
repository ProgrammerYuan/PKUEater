...
public class ImageLoader {
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        listener.onLoadingStarted(uri, imageAware.getWrappedView());
//        System.out.println("displayImage memoryCacheKey:"+memoryCacheKey);
...
//    public void addToMemoryCache(ImageView iv,String url,Bitmap b) {
//        ImageSize targetSize = ImageSizeUtils.defineTargetSizeForView( new ImageViewAware(iv), configuration.getMaxImageSize());
//        String memoryCacheKey = MemoryCacheUtils.generateKey(url, targetSize);
//        System.out.println("addToMemoryCache memoryCacheKey:"+memoryCacheKey);
//        configuration.memoryCache.put(memoryCacheKey,b);
//    }
