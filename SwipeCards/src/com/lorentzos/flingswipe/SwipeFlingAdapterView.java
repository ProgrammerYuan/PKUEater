...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    int card_margin_left = 0;
    int card_margin_right = 0;
    int card_margin_top = 0;
    int card_margin_bottom = 0;
    int card_width = 0;
    int card_height = 0;
    ...
    private void makeAndAddView(View child) {
        ...
        if (lp == null) {
            ...
            lp.topMargin = card_margin_top;
            lp.bottomMargin = card_margin_bottom;
            lp.leftMargin = card_margin_left;
            lp.rightMargin = card_margin_right;
        }
...
//            } else {
//                int childWidthSpec = getChildMeasureSpec(getWidthMeasureSpec(),
//                        getPaddingLeft() + getPaddingRight() + card_margin_left + card_margin_right, card_width);
//                int childHeightSpec = getChildMeasureSpec(getHeightMeasureSpec(),
//                        getPaddingTop() + getPaddingBottom() + card_margin_top + card_margin_bottom, card_height);
//                child.measure(childWidthSpec, childHeightSpec);
//            }
    ...
    public void setCard_margin_left(int card_margin_left) {
        this.card_margin_left = card_margin_left;
    }

    public void setCard_margin_right(int card_margin_right) {
        this.card_margin_right = card_margin_right;
    }

    public void setCard_margin_top(int card_margin_top) {
        this.card_margin_top = card_margin_top;
    }

    public void setCard_margin_bottom(int card_margin_bottom) {
        this.card_margin_bottom = card_margin_bottom;
    }
