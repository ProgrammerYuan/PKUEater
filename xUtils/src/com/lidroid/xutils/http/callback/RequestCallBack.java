...
//    public abstract void onFailure(HttpException error, String msg);
    public abstract void onSuccess(ResponseInfo<T> responseInfo, JSONObject data);

    public abstract void onFailure(HttpException error, String msg, JSONObject data);
}
