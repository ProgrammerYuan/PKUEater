...
public class RequestParams {
    ...
    private LinkedHashMap<String, String> raw_param;

    private Priority priority;

    public RequestParams() {
        raw_param = new LinkedHashMap<String, String>();
    }
    ...
    public void addQueryStringParameter(NameValuePair nameValuePair) {
        ...
        raw_param.put(nameValuePair.getName(), nameValuePair.getValue());
    ...
    public void addQueryStringParameter(List<NameValuePair> nameValuePairs) {
        ...
        if (nameValuePairs != null && nameValuePairs.size() > 0) {
            for (NameValuePair pair : nameValuePairs) {
                ...
                raw_param.put(pair.getName(), pair.getValue());
    ...
    public LinkedHashMap<String, String> getRawParam() {
        return raw_param;
    }
    /**
