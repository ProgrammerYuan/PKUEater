...
public class PullToZoomScrollView extends ScrollView {
    ...
    private OnScrollChangedListenerFadeForPullToRefresh mOnScrollChangedListenerFadeForPullToRefresh;
...
//    public void setHeaderViewLayoutParam(ViewGroup.LayoutParams params) {
//        if (mHeaderContainer != null) {
//            mHeaderContainer.setLayoutParams(params);
//        }
//    }
//
//    public void setZoomViewLayoutParam(ViewGroup.LayoutParams params) {
//        if (mZoomContainer != null) {
//            mZoomContainer.setLayoutParams(params);
//        }
//    }
    ...
    protected void onScrollChanged(int left, int top, int oldLeft, int oldTop) {
        ...
        if (mOnScrollChangedListenerFadeForPullToRefresh != null) {
            mOnScrollChangedListenerFadeForPullToRefresh.onScrollChanged(this, left, top, oldLeft, oldTop);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (isHeaderTop && isEnableZoom) {
            switch (0xFF & ev.getActionMasked()) {
    ...
    public void setOnScrollChangedListener(OnScrollChangedListenerFadeForPullToRefresh listener) {
        mOnScrollChangedListenerFadeForPullToRefresh = listener;
    }
