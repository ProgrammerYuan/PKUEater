...
public class Slider extends CustomRelativeLayout {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(Utils.dpToPx(16,
                getResources()), Utils.dpToPx(16, getResources()));
...
//        else{
//            Paint circle = new Paint();
//            circle.setColor(getResources().getColor((value == min) ? disable_color : backgroundColor));
//            temp.drawCircle(ball.getX() + ball.getWidth() / 2, ball.getY() + ball.getHeight() / 2, pressed_radius, trans);
//        }
//
//
//        if (value == min) {
...
//            Paint transparentPaint = new Paint();
//            paint.setColor(disable_color);
////            trans.setColor(getResources().getColor(
////                    android.R.color.transparent));
////            trans.setXfermode(new PorterDuffXfermode(
////                    PorterDuff.Mode.CLEAR));
//            canvas.drawCircle(ball.getX() + ball.getWidth() / 2,
//                    ball.getY() + ball.getHeight() / 2,
//                    ball.getWidth() / 2, transparentPaint);
...
//            paint.setAntiAlias(true);
//            canvas.drawCircle(ball.getX() + ball.getWidth() / 2,
//                    getHeight() / 2, pressed_radius, paint);
//        }
//        if (isLastTouch) {
//            Logger.out("invalidate");
//            invalidate();
