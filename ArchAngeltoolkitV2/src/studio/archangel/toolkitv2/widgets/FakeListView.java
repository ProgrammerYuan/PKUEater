 ...
 * @author Michael
 */
public class FakeListView extends LinearLayout implements Constructable {
...
//        Logger.out("refresh");
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            v = adapter.getView(i, null, FakeListView.this);
            v.setLayoutParams(new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
