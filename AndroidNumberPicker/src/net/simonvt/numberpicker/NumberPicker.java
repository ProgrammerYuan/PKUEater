...
//        mIncrementButton.setVisibility(visible ? View.VISIBLE : View.GONE);
//        mDecrementButton.setVisibility(visible ? View.VISIBLE : View.GONE);
//
//    }

    //    public void setVirualButtonDrawable(Drawable d){
//        mVirtualButtonPressedDrawable=d;
//    }
    @Override
    ...
    public void setValue(int value, boolean b) {
        setValueInternal(value, b);
    }
